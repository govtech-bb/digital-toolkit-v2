...
title: Barbados Digital Service Standards
lede: The standard your service must meet. Start here if your ministry, department or agency (MDA) is planning a new digital service or improving an existing one.
---
...
This will ensure that users use the service as it meets their needs. If the service is not built with users in mind, there may be low adoption of the service, and resources used in building the service would have been wasted.
...
- Understanding problems
  - [How understanding problems helps us to help users](https://dwpdigital.blog.gov.uk/2017/10/30/how-understanding-problems-helps-us-to-help-users/)
  - [What are problem statements?](https://www.interaction-design.org/literature/topics/problem-statements?srsltid=AfmBOopE68BtBy3hMwghLq4gxu0DjILBGtUBeMpfZUt3yxi2tp9j6Uwc)
...
- Product managers
- User researchers
- Subject matter experts in e.g. procurement, health, education within (and potentially outside) the relevant government ministries, departments, and agencies
...
The government exists to serve all citizens. The services the government runs must do the same. Therefore, members of the public who need to access these services should be able to.
...
- [Designing for illiteracy in digital public services](https://public.digital/pd-insights/blog/2024/05/designing-for-illiteracy-in-digital-public-services)
...
The users of the public services in Barbados are not all proficient in reading and writing of the English language. You should ensure that all users of the service, regardless of background, ethnicity, and language are able to access the content in the service.
...
When you make a decision about technology, you’re making a significant investment. The choices you make will have a significant impact on your ability to create, iterate and operate the service in a sustainable way.
...
- [The UK’s Design System](https://design-system.service.gov.uk/)
...
By talking to other Ministries, Departments and Agencies (MDAs) the service team should establish if MDAs have built or are building something similar. When there are similarities, the team should build on and improve what already exists, especially in the case of components like payment gateways and existing databases where there is likely to be common user needs, and in the Design System where there are reusable resources. The team should also ensure that it liaises with MIST to adopt any Digital Public Infrastructure that’s been put in place by the government (e.g digital identity, payments and data exchange / interoperability platforms)

### Why it’s important

This reduces duplication of effort across the government. This could also help teams build services faster and cheaper. Interoperability would also allow for data exchange between MDAs, which improves the overall experience of interacting with the government.
...
This means publishing source code in open code repositories in a secure way, working in the open and regularly showing the progress you’re making on your service, even as you are still building it so that other MDAs and even users can learn about the service and provide helpful feedback.

### Why it’s important

This will help facilitate knowledge exchange and capability building within the Government of Barbados. Publishing source code in open code repositories will make it easier for other MDAs to build similar services in the future.
...
Running a live service doesn’t have to mean a full team working on the service 100% of the time when the service is live. But it does mean being able to make substantial improvements throughout the lifetime of the service. Make sure you have the capacity, resources and technical flexibility to iterate and improve the service frequently.
...
The legitimacy of the service must be convincing, clearly indicating to users that they are transacting with the government. This means adopting and following the Barbados Design System for a consistent user experience.
...
It should also be easy for the user to learn about any alternative channels through which they can access the service if they cannot access it online.

### Why it’s important

For a service to solve users’ needs, the users must first know that it exists. Usually, those who want to access a service online think about it as an action that they would like to perform e.g. “apply for a permit to play loud music", “pay tax”, “register my baby’s birth”, “get a document notarised” etc.
